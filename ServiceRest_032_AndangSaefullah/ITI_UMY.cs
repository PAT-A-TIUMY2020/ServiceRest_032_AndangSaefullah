...
namespace ServiceRest_032_AndangSaefullah
{
    ...
    {
        [OperationContract]
        [WebGet(UriTemplate = "Mahasiswa", ResponseFormat = WebMessageFormat.Json)] // membuat slash, selalu relative
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_032_AndangSaefullah.ContractType".
    [DataContract]
